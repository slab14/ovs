...
static void
compose_signkernel_action(struct xlate_ctx *ctx)
{
  nl_msg_put_flag(ctx->odp_actions, OVS_ACTION_ATTR_SIGNKERNEL);
}

static void
compose_verifykernel_action(struct xlate_ctx *ctx)
{
  nl_msg_put_flag(ctx->odp_actions, OVS_ACTION_ATTR_VERIFYKERNEL);
}
                 ...
                 bool group_bucket_action)
{
    ...
    OFPACT_FOR_EACH (a, ofpacts, ofpacts_len) {
        ...
        case OFPACT_SIGNKERNEL:
            compose_signkernel_action(ctx);
            break;

        case OFPACT_VERIFYKERNEL:
            compose_verifykernel_action(ctx);
            break;
